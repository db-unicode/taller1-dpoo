...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país que representa el atleta consultado");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Permite al usuario consultar el país que representa un atleta usando su nombre
	 */
	private void ejecutarBusquedaPaisAtleta()
	{	
		System.out.println("\n" + "País que representa el atleta" + "\n");
		String nombreAtleta = input("Ingrese el nombre del atleta");
		String paisAtleta = calculadora.obtenerPaisPorAtleta(nombreAtleta);
		if (!paisAtleta.equals("NULL")) 
		{
			System.out.println("El atleta con nombre " + nombreAtleta + " representa a " + paisAtleta);
		} 
		else
		{
			System.out.println("El atleta con nombre " + nombreAtleta +" no se ha encontrado en la base de datos");
		}
